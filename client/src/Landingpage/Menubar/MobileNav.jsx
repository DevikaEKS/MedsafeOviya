...
const MobileNav = ({setHamToggle}) => {
    ...
    return (
        <div className='d-flex-col gap-3 bold px-5 py-2'>
            <div className='mb-2'>
                <Link to="/" className="custom-link text-black" onClick={() => setHamToggle(false)}>HOME</Link>
            </div>
            ...
            <div className='mb-2'>
                ...
                {showDropdown1 && (
                    <div
                        className=""
                        >
                        <Link to="/about-us" className="dropdown-item pt-1" onClick={() => setHamToggle(false)}> 
                            About Us
                        </Link>
                        <Link to="/our-founder" className="dropdown-item pt-1" onClick={() => setHamToggle(false)}>
                            Our Founder
                        </Link>
                        <Link to="/our-board" className="dropdown-item pt-1" onClick={() => setHamToggle(false)}>
                            Our Board
                        </Link>
                    </div>
                )}
            ...
            <div className='mb-2'>
                <Link to="/news" className="custom-link text-black" onClick={() => setHamToggle(false)}>NEWS</Link>
            </div>
            <div className='mb-2'>
                <Link to="/downloads" className="custom-link text-black" onClick={() => setHamToggle(false)}>DOWNLOADS</Link>
            </div>
            <div className='mb-2'>
                <Link to="/careers" className="custom-link text-black" onClick={() => setHamToggle(false)}>CAREERS</Link>
            </div>
            <div className='mb-2'>
                <Link to="/contact" className="custom-link text-black" onClick={() => setHamToggle(false)}>CONTACT</Link>
            </div>
        </div>
    );
};
