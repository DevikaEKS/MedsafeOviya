...
function Founder() {
  return (
    <div className="container-fluid fpart text-light">
      <h1 className='py-2 subhead2 text-light'>Our Founder</h1>
      <div className="row align-items-center mx-1 mx-lg-5">
        ...
        <div className="col-sm-12 col-md-6 d-flex flex-column justify-content-center text-center text-md-start">
          <h1 className="foundername text-start">Dr J Vijay Venkatraman</h1>
          <p className="pt-2 founderqualification text-start">
          ...
          <div className='row text-justify founderparas py-3'>
          <p>
