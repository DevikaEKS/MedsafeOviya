...
function Careersdata() {
  return (
    <div className='container py-5'>
        ...
        <p>We at Oviya MedSafe value diversity as an integral part of our workplace culture. We expect our staff to understand and respect individual differences, which virtue we believe is imperative for every prospective team member of ours.</p>
        ...
        <a href="mailto:careers@oviyamedsafe.com" style={{ textDecoration: 'none', color: '#0D868F' }}>
